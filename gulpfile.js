...
const config = {
  ...
  scripts: {
    ...
    webcomponents: {
      src: './src/js/webcomponents/webcomponents.js',
      dest: 'dist/js/webcomponents/',
      watch: 'src/js/webcomponents/**/*',
    },
  },
  images: {
    toolkit: {
  ...
  copy: {
    webcomponents: {
      src: 'stencil/dist/**/*',
      entry: 'src/assets/webcomponents/bitmarck.js',
      dest: 'dist/assets/webcomponents/',
      dist: 'src/assets/webcomponents/',
      watch: 'src/js/**/*',
    },
  },
};
...
// watch and copy js files from stencil.js
gulp.task('webcomponents:copy', () => {
  gulp.src(config.copy.webcomponents.src)
    .pipe(gulp.dest(config.copy.webcomponents.dist))
    .pipe(gulp.dest(config.copy.webcomponents.dest));
});
...
gulp.task('serve', () => {
  ...
  gulp.task('webcomponents:watch', ['webcomponents:copy'], browserSync.reload);
  gulp.watch(config.scripts.webcomponents.watch, ['webcomponents:watch']);
